...
\input thesis/metadata.tex

% Generate metadata in XMP format for use by the pdfx package
\input thesis/xmp.tex
...
\usepackage[toc,acronym]{glossaries}    % glossary, zkratky
...
\include{thesis/chapters/02_context}
\include{thesis/chapters/03_core_concepts}
\include{thesis/chapters/04_entity_map_translation}
\include{thesis/chapters/05_query_translation}
\include{thesis/chapters/06_advisor_ilp}
\include{thesis/chapters/07_arch_impl}
\include{thesis/chapters/08_related_work}

% \include{chapters/chap_notes}

\include{thesos/epilog}
