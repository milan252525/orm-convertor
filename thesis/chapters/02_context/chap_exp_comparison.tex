...
The differences in measured time for queries \hyperref[query:b5]{B5} and \hyperref[query:b6]{B6} are almost negligible. The generated queries had no difference. Surprising results are in memory allocation, where Dapper consumed more memory than PetaPoco while running the same query and returning the same amount of columns and rows.
...
% TODO profiled queries as attachment?
